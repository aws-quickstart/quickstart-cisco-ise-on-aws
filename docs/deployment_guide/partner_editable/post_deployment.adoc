...
NOTE: For AWS deployments, the initial {partner-product-short-name} administrator user name is `admin` in {partner-product-short-name} 3.1 and `iseadmin` in {partner-product-short-name} 3.2.
