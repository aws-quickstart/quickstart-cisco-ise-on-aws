...
image::https://aws-quickstart.github.io/quickstart-cisco-ise-on-aws/docs/operational_guide/images/quickstart-cisco-ise-on-aws-architecture-DeploymentStateMachine.png[DeploymentStateMachineArchitecture]
...
image::https://aws-quickstart.github.io/quickstart-cisco-ise-on-aws/docs/operational_guide/images/quickstart-cisco-ise-on-aws-architecture-FailoverStateMachine.png[FailoverStateMachineArchitecture]
